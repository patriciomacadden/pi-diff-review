...
6. lets you draft single-line or multi-line comments on the original side, modified side, or whole file
7. automatically submits the resulting feedback prompt to pi when you finish the review
